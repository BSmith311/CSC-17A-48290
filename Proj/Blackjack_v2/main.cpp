 ...
 * Purpose: Project 1, Blackjack (v2)
 * Current: Added menu (looped game play, show stats, show rules)
 *          Formatting fixes
 * Future:  Change cards to have spacing instead of underscores
 *          Pause between turns, if player hits 21 program goes too quick
 */
...
int main(int argc, char** argv) {
    ...
    do{
        ...
        //Process inputs
        switch(choice){
            case PLAY:{blackjack(gWon,gPlay,pDraw,dDraw,name,inFile,inName);break;}
            case STATS:{stats(gWon,gPlay,pDraw,dDraw);break;}
